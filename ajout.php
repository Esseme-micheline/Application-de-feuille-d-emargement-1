  ...
  if(isset($_POST['bouton-valider'])){
    if(isset($_POST['Nom']) && isset($_POST['idue'])){
      ...
      if ($con->connect_error) {
        ...
        $sqlquery = "INSERT INTO enseignant (`Nom`,`idue`) VALUES
        ('$Nom', '$idue')";
            ...
            <div class="content">
              <div class="col-lg-5" data-aos="fade">
                 <form action="" method="post" class="php-email-form">
                  <h3>Ajout Enseignant </h3><br><br>
                  
                  <div class="row gy-3">
    
                    <div class="col-md-12">
                      <input type="text" name="Nom" class="form-control" placeholder="Nom Enseignant" required>
                    </div>
