...
if(isset($_POST['bouton-valider'])){
  if(isset($_POST['Nomsemestre'])){
    ...
    if ($con->connect_error) {
      ...
      $sqlquery = "INSERT INTO semestre (`Nomsemestre`) VALUES
      ('$Nomsemestre')";
            ...
            <div class="content">
              <div class="col-lg-5" data-aos="fade">
                 <form action="" method="post" class="php-email-form">
                  <h3>Ajout Semestre </h3><br><br>
                  
                  <div class="row gy-3">
    
                    <div class="col-md-12">
                      <input type="text" name="Nomsemestre" class="form-control" placeholder="semestre" required>
                    </div>
