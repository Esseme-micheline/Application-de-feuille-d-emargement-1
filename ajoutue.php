...
if(isset($_POST['bouton-valider'])){
  if(isset($_POST['idue']) && isset($_POST['Nomue']) && isset($_POST['idsemestre']) && isset($_POST['idniveau'])){
    $id = $_POST['idue'];
    $Nom = $_POST['Nomue'];
    ...
    if ($con->connect_error) {
      ...
      $sqlquery = "INSERT INTO ue (`idue`,`Nomue`,`idsemestre`,`idniveau`) VALUES
      ('$id','$Nom','$idsemestre','$idniveau')";
              ...
              <div class="col-lg-5" data-aos="fade">
                 <form action="" method="post" class="php-email-form">
                  ...
                  <div class="row gy-3">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="idue" class="form-control" placeholder="UE" required>
                    </div>
    
                    <div class="col-md-12 ">
                      <input type="text" class="form-control" name="Nomue" placeholder="Nom_ue" required>
                    </div>
                    <div class="col-md-12 ">
                        <input type="text" class="form-control" name="idsemestre" placeholder="semestre" required>
                      </div>
                      <div class="col-md-12 ">
                        <input type="text" class="form-control" name="idniveau" placeholder="niveau" required>
                      </div>
